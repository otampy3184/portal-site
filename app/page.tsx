			...
			<div className=" py-6 sm:py-8 lg:py-12">
				<div className="mx-auto max-w-screen-xl px-4 md:px-8">
					<div className="mb-10 md:mb-16">
						<h2 className="mb-4 text-center text-2xl font-bold text-zinc-100 md:mb-6 lg:text-3xl">Meet our Team</h2>

						<p className="mx-auto max-w-screen-md text-center text-zinc-200 md:text-lg">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated.</p>
					</div>
					...
					<div className="grid grid-cols-2 gap-x-4 gap-y-6 sm:gap-y-8 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-200 sm:text-left md:text-lg">John McCulling</div>
								<p className="text-center text-sm text-zinc-200 sm:text-left md:text-base">Founder / CEO</p>
							</div>
						</div>
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							<div className="h-24 w-24 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-32 md:w-32">
							...
							<div>
								<div className="text-center font-bold text-zinc-200 sm:text-left md:text-lg">Kate Berg</div>
								<p className="text-center text-sm text-zinc-200 sm:text-left md:text-base">CFO</p>
							</div>
						</div>
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							<div className="h-24 w-24 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-32 md:w-32">
							...
							<div>
								<div className="text-center font-bold text-zinc-200 sm:text-left md:text-lg">Greg Jackson</div>
								<p className="text-center text-sm text-zinc-200 sm:text-left md:text-base">CTO</p>
							</div>
						</div>
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							<div className="h-24 w-24 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-32 md:w-32">
							...
							<div>
								<div className="text-center font-bold text-zinc-200 sm:text-left md:text-lg">Robert Greyson</div>
								<p className="text-center text-sm text-zinc-200 sm:text-left md:text-base">Creative Director</p>
							</div>
						</div>
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							<div className="h-24 w-24 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-32 md:w-32">
							...
							<div>
								<div className="text-center font-bold text-zinc-200 sm:text-left md:text-lg">John Roberts</div>
								<p className="text-center text-sm text-zinc-200 sm:text-left md:text-base">Investor Relations</p>
							</div>
						</div>
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							<div className="h-24 w-24 overflow-hidden rounded-full bg-gray-100 shadow-lg md:h-32 md:w-32">
							...
							<div>
								<div className="text-center font-bold text-zinc-200 sm:text-left md:text-lg">Judy Amandez</div>
								<p className="text-center text-sm text-zinc-200 sm:text-left md:text-base">Senior Art Director</p>
							</div>
						</div>
					</div>
				</div>
				...
				<footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
					<div className="flex flex-col items-center border-t pt-6">
						...
						<div className="flex gap-4">
							<a href="#" target="_blank" className="text-white transition duration-100 hover:text-gray-500 active:text-gray-600">
