...
export default function Home() {
	return (
		<div className="w-screen h-max bg-gradient-to-tl from-blue-500 via-blue-600/20 to-blue-400">
			...
			<div className=" py-6 sm:py-8 lg:py-12">
				<div className="mx-auto max-w-screen-xl px-4 md:px-8">
					<div className="mb-10 md:mb-16">
						<h2 className="mb-4 text-center text-2xl font-bold text-zinc-300 md:mb-6 lg:text-3xl">Meet our Team</h2>
					...
					<div className="grid grid-cols-2 gap-x-4 gap-y-6 sm:gap-y-8 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-12">
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-500 sm:text-left md:text-lg">John McCulling</div>
						...
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-500 sm:text-left md:text-lg">Kate Berg</div>
						...
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-500 sm:text-left md:text-lg">Greg Jackson</div>
						...
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-500 sm:text-left md:text-lg">Robert Greyson</div>
						...
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-500 sm:text-left md:text-lg">John Roberts</div>
						...
						<div className="flex flex-col items-center gap-2 sm:flex-row md:gap-4">
							...
							<div>
								<div className="text-center font-bold text-zinc-500 sm:text-left md:text-lg">Judy Amandez</div>
			...
			<div className=" pt-4 sm:pt-10 lg:pt-12">
				<footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
					...
					<div className="py-8 text-center text-sm text-gray-400">© 2023 - Present Volunteer Network. All rights reserved.</div>
				</footer>
			</div>
		</div>
	);
